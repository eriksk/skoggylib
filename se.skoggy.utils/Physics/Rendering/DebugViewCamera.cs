...
{
    public class DebugViewCamera2D
    {
        ...
        public DebugViewCamera2D(GraphicsDevice graphics)
        {
            _graphics = graphics;
        ...
        public void Update(float dt)
        {
            ...
            _currentPosition = _targetPosition; // += 100f * delta * inertia * (dt / 1000f);
            _currentRotation += 80f * rotDelta * rotInertia * (dt / 1000f);
